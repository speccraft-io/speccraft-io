...
tool most teams use today is [fake timers](/vs/fake-timers), which fix one order per test; and
[Effect](/vs/effect) prevents many bugs by construction without searching orders.
