...
<a href="/assets/positioning.png" class="lightbox-trigger"><img src="/assets/positioning.png" alt="A two-by-two map: new spec language vs. plain code in your language on one axis, exhaustive checking vs. random sampling on the other. SpecCraft sits in the plain-code, exhaustive-checking quadrant with Stateright, pnueli and Polygraph; tla-precheck and stateproof sit near the axis as TypeScript compiled to TLA+; XState graph and modality-ts are below them; fast-check, QuickCheck, chronos, unflake and Antithesis are in the random-sampling half; TLA+, Quint, Alloy, FizzBee, P and SPIN are in the new-spec-language half."></a>
...
<a href="/assets/model-vs-real-code.png" class="lightbox-trigger"><img src="/assets/model-vs-real-code.png" alt="A spectrum from 'checks a model of the system' to 'exercises the real running code'. Dedicated spec languages, XState graph tools, Stateright, and SpecCraft sit at the model end; stateproof and property-based testing (fast-check, QuickCheck, Hypothesis) bridge the middle; concurrency testers (Coyote, loom, shuttle) and whole-system simulation (DST, Antithesis) sit at the real-code end. SpecCraft sits at the model end with an arrow toward real code: conformance and inline specs."></a>
