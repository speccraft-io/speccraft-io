...
SpecCraft is built by [Oleksandr Zalizniak](https://zalizniak.com). Follow along on [GitHub](https://github.com/orgs/speccraft-io/repositories) and [LinkedIn](https://www.linkedin.com/company/speccraft-io), or get in touch: [alex@zalizniak.com](mailto:alex@zalizniak.com).
