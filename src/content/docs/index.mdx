...
SpecCraft is built by [Oleksandr Zalizniak](https://zalizniak.com). Follow along on [GitHub](https://github.com/speccraft-io) and [LinkedIn](https://www.linkedin.com/company/speccraft-io), or get in touch: [alex@zalizniak.com](mailto:alex@zalizniak.com).
