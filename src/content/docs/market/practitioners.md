...
| [Jean-Jacques Dubray](https://www.linkedin.com/in/jdubray/) ([Polygraph](/vs/polygraph)) | An LLM writes a JavaScript spec in SAM, his State-Action-Model pattern, which is then checked against the code | Builds it as Cognitive Fab LLC; method from his July 2026 paper. |
| [David R. MacIver](https://hegel.dev) ([Hegel](/vs/hegel)) | Hypothesis-style property-based testing, including for TypeScript | Created Hypothesis. |
| [Liam DeVoe](https://hegel.dev) ([Hegel](/vs/hegel)) | Co-builds Hegel | Hypothesis maintainer at Antithesis. |
| [Sandro Maglione](https://github.com/typeonce-dev) ([effect-machine](/vs/effect-machine)) | Schema-first statecharts for Effect, with state exploration in tests | Writes and teaches about Effect, as Typeonce. |
| [Nada Amin](https://github.com/midspiral/LemmaScript) ([LemmaScript](/vs/lemmascript)) | Proves TypeScript functions correct with Dafny or Lean | Associate professor of computer science at Harvard; builds it with Midspiral. |
| [Doniyor Botirov](https://github.com/BOTIROFF-D) ([pnueli](/vs/pnueli)) | Explicit-state model checker in TypeScript | Founder of dbit.one; also builds unflake, bulwark and adya. |
| [Anders Hessellund Jensen](https://github.com/andershessellund) ([stifinder](/vs/stifinder)) | State-space explorer for JavaScript | Self-employed developer in Denmark; also `valsem` and `kilde`. |
| [kingbootoshi](https://github.com/kingbootoshi) ([tla-precheck](/vs/tla-precheck)) | Compiles a TypeScript DSL to TLA+ and proves both match | Solo project, no commits since early April 2026. |
| [Dennis Berger](https://www.linkedin.com/in/deb3rg/) ([libpetri](https://github.com/debe/libpetri)) | Coloured time Petri net runtime for TypeScript, Java and Rust, with deadlock and bounds checks through Z3 | Staff engineer at Otto; it runs their production commerce assistant. Also swaps n8n's and Google ADK's scheduling core for a net. |
| [Oleksandr Zalizniak](https://zalizniak.com) ([SpecCraft TS](/vs/speccraft-ts)) | Model checker as a TypeScript library | Author of this site; started September 2026. |
| [Leslie Lamport](https://lamport.azurewebsites.net/tla/tla.html) ([TLA+](/tools/tla-plus)) | Created TLA+ | Also teaches it in the TLA+ Video Course. |
| [K. Rustan M. Leino](https://mitpress.mit.edu/9780262546232/program-proofs/) ([Dafny](/tools/dafny)) | Created Dafny | Wrote the book *Program Proofs*. |
...
| [Stately](https://stately.ai/) | Builds XState and its graph tools ([XState](/vs/xstate)) | The company of David Khourshid. |
| [Midspiral](https://midspiral.com) | Builds LemmaScript, which proves TypeScript functions with Dafny or Lean ([LemmaScript](/vs/lemmascript)) | Almost all commits by Nada Amin. |
