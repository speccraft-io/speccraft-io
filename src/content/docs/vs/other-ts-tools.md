...
| [dspec](https://github.com/mizchi/dspec) | A prototype where a typed formal model is the master spec, with conformance evidence from the code | 35 stars, not on npm | Spec-first: the model is the source of truth and the code is checked against it; an early prototype |
