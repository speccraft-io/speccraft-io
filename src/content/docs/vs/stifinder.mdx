...
**How close to SpecCraft:** close. An explicit-state explorer like SpecCraft's engine, but it ranks failures by the
fewest departures from the expected schedule and does not check real code.
