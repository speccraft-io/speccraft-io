...
**How close to SpecCraft:** very close. Of everything we have found, it is the closest to SpecCraft's own engine and
ahead of it on symmetry, partial-order reduction and liveness, but it checks the model only, not real code.
