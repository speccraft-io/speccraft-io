...
copy is more likely to drift from the original. For loops and mutation, [Dafny](/formal-methods/dafny) is the closer fit.
...
- [LemmaScript](/typescript-formal-methods/lemmascript): a tool that skips the manual copy. You write contract comments in the
