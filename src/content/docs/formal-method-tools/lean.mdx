...
copy is more likely to drift from the original. For loops and mutation, [Dafny](/formal-method-tools/dafny) is the closer fit.
...
<details>
<summary>The CI workflow: <code>.github/workflows/ci.yml</code> (32 lines)</summary>
...
- [LemmaScript](/typescript-formal-method-tools/lemmascript): a tool that skips the manual copy. You write contract comments in the
