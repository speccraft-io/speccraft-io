...
Quint is not the tool for proving one function's math right for every input. See the [Dafny](/formal-method-tools/dafny) and
[Lean](/formal-method-tools/lean) pages for that.
...
If you need those, use [TLA+](/formal-method-tools/tla-plus) directly.
...
- [TLA+ for TypeScript developers](/formal-method-tools/tla-plus), the method underneath, used directly.
