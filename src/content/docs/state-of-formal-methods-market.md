...
| Tool | Job mentions | What it is |
|---|---|---|
| [Lean / Lean 4](https://lean-lang.org) | 9 | Interactive theorem prover — the single most-named tool found, concentrated at AI labs (Harmonic, DeepMind, Oath Technologies). |
| [Coq / Rocq](https://rocq-prover.org) | 8 | Interactive theorem prover, same AI-lab cluster as Lean. |
| SMT solvers ([Z3](https://github.com/Z3Prover/z3), [CVC5](https://cvc5.github.io), [MathSAT](https://mathsat.fbk.eu)) | 8 | Underlying decision engine for most higher-level tools; rarely hired for by name alone. |
| [TLA+ / TLC / Apalache](https://lamport.azurewebsites.net/tla/tla.html) | 6 | Exhaustive model checker — Huawei, Oracle, Architect Labs, Sigil Logic, Johns Hopkins APL, Google Cloud. |
| [Isabelle/HOL](https://isabelle.in.tum.de) | 4 | Interactive theorem prover; used for the seL4 verified microkernel. |
| [Agda](https://agda.readthedocs.io) | 2 | Interactive theorem prover, both mentions at Harmonic. |
| [Verus](https://github.com/verus-lang/verus) | 1 | Verification-aware Rust, used for Google Cloud's C++→Rust migration. |
| [Alloy](https://alloytools.org), [SPIN](https://spinroot.com), [Quint](https://quint-lang.org), [P](https://github.com/p-org/P), [Antithesis](https://antithesis.com), [QuickCheck/Hypothesis](https://hypothesis.readthedocs.io), [Coyote](https://github.com/microsoft/coyote), [FizzBee](https://fizzbee.io), [Stateright](https://github.com/stateright/stateright), [stateproof](https://github.com/HexaField/stateproof), [loom](https://github.com/tokio-rs/loom), [XState graph](https://stately.ai/docs/xstate-graph), [fast-check](https://fast-check.dev/) | 0-1 each | Real, in some cases widely-adopted tools — none of them something a job posting names by itself. |
| [Certora Prover/CVL](https://www.certora.com), [K Framework/KEVM](https://github.com/runtimeverification/k), [Cryptol/SAW](https://galois.com), [Dafny](https://dafny.org), [UPPAAL](https://uppaal.org), [EasyCrypt](https://www.easycrypt.info), [F\*](https://www.fstar-lang.org), [CryptoVerif](https://bblanche.gitlabpages.inria.fr/CryptoVerif/) | 0-1 each | Adjacent smart-contract/cryptography tools, same pattern. |
