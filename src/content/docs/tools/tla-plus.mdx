...
That is extra work, and it helps in three ways:
...
The cost is a second artifact that must keep matching the code. The rest of this page shows how to do that with a replay
test in vitest.
