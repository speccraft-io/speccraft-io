...
Quint is not the tool for proving one function's math right for every input. See the [Dafny](/tools/dafny) and
...
If you need those, use [TLA+](/tools/tla-plus) directly.
