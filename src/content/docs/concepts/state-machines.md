...
| Library | What it is |
|---|---|
| [XState](/vs/xstate) | Statecharts and actors. [`xstate/graph`](https://stately.ai/docs/xstate-graph) walks a machine's graph to generate test paths |
...
The lazy connection on the [TLA+ page](/tools/tla-plus) is an example: two callers, each with its own position, and
