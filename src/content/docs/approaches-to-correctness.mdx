---
title: Known methods
description: A map of how software correctness gets established — the problems durable-workflow developers hit, the vocabulary of spec, model, design, and implementation, and the families of approaches that address them.
---
