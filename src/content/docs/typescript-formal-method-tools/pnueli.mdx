...
- **Plain TypeScript, no Java.** You write the model as state and actions and install only the npm package; unlike
  [stateproof](/typescript-formal-method-tools/stateproof) and [tla-precheck](/typescript-formal-method-tools/tla-precheck), there is no translation step.
...
- **Fewer kinds of "eventually" rules.** [TLA+](/formal-method-tools/tla-plus) covers more.
