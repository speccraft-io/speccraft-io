...
export default defineConfig({
	...
	redirects: {
		...
		'/market': '/market/tools',
		'/vs/fake-timers': '/typescript-formal-method-tools/other-ts-tools',
		'/vs/effect': '/typescript-formal-method-tools/other-ts-tools',
		...
		'/tools/tla-plus': '/formal-method-tools/tla-plus',
		'/tools/quint': '/formal-method-tools/quint',
		'/tools/dafny': '/formal-method-tools/dafny',
		'/tools/lean': '/formal-method-tools/lean',
		'/vs/bombadil': '/typescript-formal-method-tools/bombadil',
		'/vs/effect-machine': '/typescript-formal-method-tools/effect-machine',
		'/vs/fast-check': '/typescript-formal-method-tools/fast-check',
		'/vs/hegel': '/typescript-formal-method-tools/hegel',
		'/vs/lemmascript': '/typescript-formal-method-tools/lemmascript',
		'/vs/libpetri': '/typescript-formal-method-tools/libpetri',
		'/vs/other-ts-tools': '/typescript-formal-method-tools/other-ts-tools',
		'/vs/pnueli': '/typescript-formal-method-tools/pnueli',
		'/vs/polygraph': '/typescript-formal-method-tools/polygraph',
		'/vs/speccraft-ts': '/typescript-formal-method-tools/speccraft-ts',
		'/vs/stateproof': '/typescript-formal-method-tools/stateproof',
		'/vs/stifinder': '/typescript-formal-method-tools/stifinder',
		'/vs/tla-precheck': '/typescript-formal-method-tools/tla-precheck',
		'/vs/xstate': '/typescript-formal-method-tools/xstate',
	},
	markdown: {
		// External links (anything with a protocol, e.g. https://) open in a new tab;
		// internal Starlight links stay relative (e.g. /formal-method-tools/quint) so they're
			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{ label: 'libpetri', link: '/typescript-formal-method-tools/libpetri' },
						...
						{ label: 'Some more TS Tools', link: '/typescript-formal-method-tools/other-ts-tools' },
					],
				},
				{
					label: 'Use cases',
